...
def train():
    ...
    for epoch in range(args.epoch):
        ...
        for batch_idx, (batch_token, batch_label, batch_attn_mask) in enumerate(train_dataloader):
            ...
            weighting_output = model_helper(batch_token, batch_attn_mask)

            lcl_loss = (loss_fn["lambda_loss"]*loss_fn["CE"](sigmoid_fn(classifier_output), batch_label)) + ((1-loss_fn["lambda_loss"])*loss_fn["LCL"](normalized_output,batch_label,weighting_output))
